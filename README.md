...
[![Org CI/CD](https://github.com/oaslananka-lab/fovux/actions/workflows/org-ci.yml/badge.svg)](https://github.com/oaslananka-lab/fovux/actions/workflows/org-ci.yml)
...
*(For a full list of tools, run `fovux-mcp --help`)*
